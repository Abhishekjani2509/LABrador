...
5. Confirm the two adapters in §5 and their owners. **Adapter B built**
   (§5); Adapter A still unowned (suggested Soliman + Abhishek).
...
- [ ] **Soliman** — item 3: `no_effect` as a third `direction` value.
