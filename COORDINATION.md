...
- **2026-08-16 02:29 UTC** — merged `msoliman6/literature-graph-mcp` (MERGED) — mapper: merge duplicate entities on UniProt accession, and repair existing graphs; merged `rafwiewiora/druggability-dossier` (MERGED) — Merge commit '2fd6503570ad4f69f753c10e726106b474eba91a' into HEAD · Land the retraction across the remaining files; mandate count reconciliation · Merge commit '4cfb91f0a0029ea4bbdcc21edf62ea92cff72e6d' into HEAD · Retract the volume separation for good; regenerate six fixture counts · Merge commit 'f41b285585273042102daed1704916e7e3b31a4b' into HEAD — typecheck+check green.
...
- **2026-08-16 04:25 UTC** — merged `AbrehamT/Hypothesis_Generator` (MERGED) — Draw the traces: contradicted edges red, supported blue, proposal dotted — typecheck+check green.
