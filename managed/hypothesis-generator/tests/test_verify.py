...
quietly delete the hypothesis from the slate. A verification process whose
...
from hyp_gen.schema import Articulation, Claim, Critique, Hypothesis
from hyp_gen.scoring import score_candidate
from hyp_gen.verify import GateContext, apply, verify
...
def test_gate_failures_do_not_block_the_hypothesis(
    ...
    hypothesis reaches the slate at all. The gates added here express
